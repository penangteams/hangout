...
import { eventState, allButtons } from "@/state/eventState";
...
export const CreateEventPage1: React.FC = () => {
  ...
  const handleAddLink = () => setState(prev => ({ ...prev, links: [...prev.links, ""] }));
          ...
          {["Photo gallery", "Privacy", "Announcements"].includes(state.activeButton || "") && (
            <div className="fixed inset-0 bg-black/50 flex items-center justify-center z-20">
              ...
              >
                ...
                <p className="text-white/50">Modal content for {state.activeButton} goes here.</p>
              </div>
            </div>
          )}
